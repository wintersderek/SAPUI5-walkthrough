...
sap.ui.define([
    "sap/ui/demo/walkthrough/model/invoiceStatusFormatter",
    "sap/ui/model/resource/ResourceModel"
], function(invoiceStatusFormatter, ResourceModel) {
    "use strict"
	...
	QUnit.test("Should return the translated texts", function (assert) {
		...
		// System under test
		var fnIsolatedFormatter = invoiceStatusFormatter.statusText.bind(oControllerStub);
